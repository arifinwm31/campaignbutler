              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 justify-between px-18">
                  <div className="text-white">
                      ...
                      <ul className="flex flex-col">
                          <li className="text-2xl/tight"><i className="ri-arrow-right-s-fill ri-2x text-red-700 mr-4"></i> <strong>Same-day </strong> domain and email setup</li>
                          <li className="text-2xl/tight"><i className="ri-arrow-right-s-fill ri-2x text-red-700 mr-4"></i> <strong>Professional</strong> website within 72 hours</li>
                          <li className="text-2xl/tight"><i className="ri-arrow-right-s-fill ri-2x text-red-700 mr-4"></i> <strong>Dedicated</strong> campaign strategist</li>
                          <li className="text-2xl/tight"><i className="ri-arrow-right-s-fill ri-2x text-red-700 mr-4"></i> <strong>Complete</strong> onboarding and training</li>
                      </ul>
                  </div>
                  <div>
                      <form action="#" className="flex flex-col text-white gap-5">
                          ...
                          <div className="flex gap-2">
                              ...
                              />
                              <label htmlFor="some_id" className="text-lg/[30px]">I agree to receive text messages from Campaign Butler. By checking this box and providing your phone number, <a href="#" className="text-red-700">Read more...</a></label>
                          </div>
